...
#ifdef __cplusplus
SIMULINK_EXPORT_FCN void slcsGetDefinedSimulinkFunctions(SimStruct* S, std::set<std::string> * slFcnList);
SIMULINK_EXPORT_FCN void slcsGetDefinedSimulinkFunctionsFromBlock(double blockH, std::set<std::string> * slFcnList);
#endif
